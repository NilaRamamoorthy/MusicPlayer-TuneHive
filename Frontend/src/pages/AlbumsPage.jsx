...
export default function AlbumsPage() {
  ...
  if (loading) return <div className="bg-white/5 border border-white/10 rounded-lg p-6">Loading albums...</div>;
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-5">
      <div className="text-lg font-semibold text-white mb-4">Albums</div>
