# Generated by Django 6.0.3 on 2026-03-04 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_quality', models.CharField(choices=[('standard', 'Standard'), ('high', 'High'), ('lossless', 'Lossless')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('billing_cycle', models.CharField(choices=[('none', 'None'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='none', max_length=20)),
